...
const MODEL_REGISTRY = {
  ...
  'deepseek-v4-pro': {
    ...
    protocol: 'anthropic', modelName: 'deepseek-chat', defaultMaxTokens: 8192, contextWindow: 1000000,
    description: '🏆 综合最强——编程、推理、写作、分析样样精通。一次能读100万字（约3本小说）。缺点：不支持图片识别，高峰期偶尔排队。适合：日常对话+专业工作，首选推荐',
  },
  'deepseek-v4-flash': {
    supplier: 'deepseek',
